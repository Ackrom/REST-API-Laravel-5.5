...
return [
    ...
    */
    'resources' => [
        'usuarios' => \App\Usuarios::class,
        'vacantes' => \App\Vacantes::class,
        'areas' => \App\Areas::class,
        'cargos' => \App\Cargos::class,
        'curriculums' => \App\Curriculums::class,
        'empresas' => \App\Empresas::class,
